...
/***/ (function(module, exports, __webpack_require__) {
	...
	var pageEvents = __webpack_require__(35);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    ...
	    production: 'https://recipe-card-backend.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signInSuccess = function signInSuccess(data) {
	  ...
	  api.getRecipes(data).then(ui.recipeGetSuccess).catch(ui.recipeGetFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getRecipes = function getRecipes(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/recipes',
	    method: 'GET',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var api = __webpack_require__(12);
	var showRecipesTemplate = __webpack_require__(14);
	var showRecipeTemplate = __webpack_require__(34);

	// function used to update the content div with recipes
	var updateUiWithRecipes = function updateUiWithRecipes() {
	  api.getRecipes().then(recipeGetSuccess).catch(recipeGetFailure);
	};
	var recipeSubmitSuccess = function recipeSubmitSuccess(data) {
	...
	var recipeSubmitFailure = function recipeSubmitFailure(error) {
	  // needs a modal
	  return error;
	};
	var recipeGetSuccess = function recipeGetSuccess(data) {
	...
	var recipeGetFailure = function recipeGetFailure(error) {
	  // needs modal
	  return error;
	};
	var singleRecipeGetSuccess = function singleRecipeGetSuccess(data) {
	  // runs handlebars and sets content to variab
	  // uses RECIPE singular as this is what is returned from API
	  // for a single recipe
	  var showRecipeHtml = showRecipeTemplate({ recipe: data.recipe });
	...
	var singleRecipeGetFailure = function singleRecipeGetFailure(error) {
	  return error;
	};
	...
	var deleteReicpeFailure = function deleteReicpeFailure(error) {
	  // needs modal
	  return error;
	};
	...
	var updateReicpeFailure = function updateReicpeFailure(error) {
	  // needs modal
	  return error;
	};

	module.exports = {
	  recipeSubmitSuccess: recipeSubmitSuccess,
	  recipeSubmitFailure: recipeSubmitFailure,
	  recipeGetSuccess: recipeGetSuccess,
	  recipeGetFailure: recipeGetFailure,
	  singleRecipeGetSuccess: singleRecipeGetSuccess,
	  singleRecipeGetFailure: singleRecipeGetFailure,
	  deleteRecipeSuccess: deleteRecipeSuccess,
	  deleteReicpeFailure: deleteReicpeFailure,
	  updateRecipeSuccess: updateRecipeSuccess,
	  updateReicpeFailure: updateReicpeFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div class='recipe"
	    ...
	    + " recipe'>\n\n    <div class='recipe-card'> <small>Recipe Name: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</small></div>\n    <div class='recipe-card-2'> <small>Recipe ID: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</small></div>\n\n  <div class='recipe-container'>\n  <div class='row'>\n\n     <div class='col-sm-6 col-md-6 col-lg-6 clearfix' display='block'>\n       <img class='recipe-image clearfix' height=\"150px\" width=\"150px\" src=\"http://i.imgur.com/dj5SOjp.jpg\">\n     </div>\n\n     <div class='col-sm-6 col-md-6 col-lg-6' margin-left='40px' width='800px' float:'right'>\n       <ul>"
	    + ((stack1 = alias1(((stack1 = blockParams[0][0]) != null ? stack1.ingredient_list : stack1), depth0)) != null ? stack1 : "")
	    + "</ul>\n     </div>\n\n  </div class='row'>\n  <div word-wrap='break-word' class='directions'>\n       Directions:&nbsp;&nbsp;"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.directions : stack1), depth0))
	    + " <br>\n  </div>\n\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = blockParams[0][0]) != null ? stack1.prep_time : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "\n  </div>\n  <hr>\n</div>\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "       Prep Time:&nbsp;&nbsp;"
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.prep_time : stack1), depth0))
	    + "\n";
	  ...
	  return "\n<div class='recipe-list' width='100%'>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.recipes : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</div>\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "      Prep Time(optional):\n         <input type=\"text\" class='form-format '  name='recipe[prep_time]' id=\"recipe-preptime-input\" value=\""
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.prep_time : stack1), depth0))
	    + "\"><br>\n";
	  ...
	  return "    <h1> <small>Recipe Name: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.title : stack1), depth0))
	    + "</small></h1>\n    <h2> <small>Recpe ID: "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.id : stack1), depth0))
	    + "</small></h2>\n    <form class='recipe-update-form' id='recipe-update-form'>\n      Recipe Title:\n         <input type=\"text\" class='form-format' name='recipe[title]' id=\"recipe-title-upate\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.title : stack1), depth0))
	    + "\"><br>\n      Recipe Ingredients:\n         <input type=\"text\" class='form-format' name='recipe[ingredient_list]' id=\"recipe-ingredients-upate\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.ingredient_list : stack1), depth0))
	    + "\"><br>\n      Recipe Directions:\n         <textarea type=\"text\" class='form-format direction-input' name='recipe[directions]' id=\"recipe-directions-update\" >"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.directions : stack1), depth0))
	    + "</textarea><br>\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.prep_time : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
	    + "       <input type=\"button\" class='delete' id='"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.id : stack1), depth0))
	    + "' value='delete'>\n       <input type=\"submit\" name='submit' class='recipeUpdate' id='"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.id : stack1), depth0))
	    + "' value='update'>\n   </form>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onRecipeSubmit = function onRecipeSubmit(event) {
	  // gets form fields and passes to create API call
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.addRecipe(data).then(ui.recipeSubmitSuccess).catch(ui.recipeSubmitFailure);
	};

	var onGetSingleRecipe = function onGetSingleRecipe(event) {
	  event.preventDefault();
	  // gets the id of the recipe to pass to GET api call
	  var data = $('#single-recipe').val();
	  api.getRecipe(data).then(ui.singleRecipeGetSuccess).catch(ui.singleRecipeGetFailure);
	};
	var onDeleteRecipe = function onDeleteRecipe(event) {
	  event.preventDefault();
	  // prompts for confirmation before delete is ran
	  if (confirm('Are you sure?') === true) {
	    api.deleteRecipe().then(ui.deleteRecipeSuccess).catch(ui.deleteReicpeFailure);
	...
	var addHandlersRecipe = function addHandlersRecipe() {
	...
	// }
	module.exports = {
	  addHandlersRecipe: addHandlersRecipe,
	  onRecipeSubmit: onRecipeSubmit,
	  onGetSingleRecipe: onGetSingleRecipe,
